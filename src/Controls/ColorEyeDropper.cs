    ...
    public class ColorEyeDropper : Button
    {
        ...
        private void SetPreview(Point mousePos)
        {
            ...
            var action = new Action(() =>
            {
                ...
                PreviewImage.SetValue(ColorEyePreviewImage.PreviewImageSourcePropertyKey, previewImage);
                PreviewImage.SetValue(ColorEyePreviewImage.PreviewSelectedColorBrushPropertyKey, previewBrush);
            });
        ...
        protected override void OnPreviewMouseLeftButtonUp(MouseButtonEventArgs e)
        {
            ...
            var newColor = EyeDropperHelper.GetPixelColor(PointToScreen(e.GetPosition(this)));

            SelectedColor = newColor;

            SelectedColour = Convert.ToString(newColor);
        }
