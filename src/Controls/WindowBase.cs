...
namespace Zhai.Famil.Controls
{
    public abstract class WindowBase : Window
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            PinButton.Click += (s, e) => Topmost = !Topmost;

            var ThemeButton = Template.FindName("ThemeButton", this) as IconButton;
            ThemeButton.Click += (s, e) => Theme = Theme == WindowTheme.Dark ? WindowTheme.Light : WindowTheme.Dark;

            var TransparentButton = Template.FindName("TransparentButton", this) as IconButton;
            TransparentButton.Click += (s, e) => IsTransparency = !IsTransparency;
        }
    }
}
