...
namespace Zhai.Famil.Controls.Notifiactions
{
    ...
    public class Notification : ContentControl
    {
        ...
        public static readonly RoutedEvent NotificationCloseInvokedEvent = EventManager.RegisterRoutedEvent("NotificationCloseInvoked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(Notification));
        ...
        public static readonly RoutedEvent NotificationClosedEvent = EventManager.RegisterRoutedEvent("NotificationClosed", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(Notification));
        ...
        public static readonly DependencyProperty CloseOnClickProperty = DependencyProperty.RegisterAttached("CloseOnClick", typeof(bool), typeof(Notification), new FrameworkPropertyMetadata(false, CloseOnClickChanged));
        ...
        private static void CloseOnClickChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            ...
            if (value)
            {
                ...
                {
                    var notification = button.FindParent<Notification>();
                    notification?.Close();
                };
            }
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            var closeButton = Template.FindName("PART_CloseButton", this) as System.Windows.Controls.Button;
            if (closeButton != null)
