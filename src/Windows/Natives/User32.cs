...
namespace Zhai.FamilTheme.Windows.Natives
{
    public static partial class User32
    {
        ...
        public static int SendMessage(IntPtr hWnd, WM_WindowsMessage wMsg, SC_SysCommand wParam) => SendMessage(hWnd, wMsg, (uint)wParam, 0);
