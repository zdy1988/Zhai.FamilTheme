...
namespace Zhai.Famil.Transitions
{
    internal sealed class PropertyChangeNotifier : DependencyObject, IDisposable
    {
        ...
        public static void SetNotifiers(DependencyObject element, List<PropertyChangeNotifier> value) => element.SetValue(NotifiersProperty, value);
        public static List<PropertyChangeNotifier> GetNotifiers(DependencyObject element) => (List<PropertyChangeNotifier>)element.GetValue(NotifiersProperty);
