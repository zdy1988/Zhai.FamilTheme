...
namespace Zhai.FamilTheme
{
    public struct ColorContext
    {
        ...
        public ColorContext(double rGB_R, double rGB_G, double rGB_B, double a, double hSV_H, double hSV_S, double hSV_V, double hSL_h, double hSL_s, double hSL_l)
        {
            _RGB_R = rGB_R;
            _RGB_G = rGB_G;
            _RGB_B = rGB_B;
        ...
        {
            var hsltuple = ColorSpaceConverter.RgbToHsl(_RGB_R, _RGB_G, _RGB_B);
        ...
        {
            var hsltuple = ColorSpaceConverter.HsvToHsl(_HSV_H, _HSV_S, _HSV_V);
            double h = hsltuple.Item1, s = hsltuple.Item2, l = hsltuple.Item3;
            _HSL_H = h;
            if (s != -1)
                _HSL_S = s;
        ...
        {
            var hsvtuple = ColorSpaceConverter.RgbToHsv(_RGB_R, _RGB_G, _RGB_B);
        ...
        {
            var hsvtuple = ColorSpaceConverter.HslToHsv(_HSL_H, _HSL_S, _HSL_L);
            double h = hsvtuple.Item1, s = hsvtuple.Item2, v = hsvtuple.Item3;
            _HSV_H = h;
            if (s != -1)
                _HSV_S = s;
        ...
        {
            var rgbtuple = ColorSpaceConverter.HslToRgb(_HSL_H, _HSL_S, _HSL_L);
        ...
        {
            var rgbtuple = ColorSpaceConverter.HsvToRgb(_HSV_H, _HSV_S, _HSV_V);
            _RGB_R = rgbtuple.Item1;
            _RGB_G = rgbtuple.Item2;
            _RGB_B = rgbtuple.Item3;
        }
